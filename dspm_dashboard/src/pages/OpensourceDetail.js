                ...
                <div className="bg-white p-5 rounded-xl shadow-sm">
                  ...
                  {runRes && (
                    <div className="mt-4 space-y-4">
                        ...
                        <div className="border rounded-lg p-3 bg-gray-50">
                          ...
                          <div className="text-xs text-gray-700 mb-2">
                            <div>
                              ...
                              {String(
                                runRes.preinstall.checked_before?.exists
                              )}
                            </div>
                            <div>
                              installed:{" "}
                              {String(runRes.preinstall.installed)}
                            </div>
                            <div>
                              check_after.exists:{" "}
                      ...
                      {/* 생성 파일 리스트 */}
                      {Array.isArray(runRes.files) &&
                        runRes.files.length > 0 && (
                          <div className="border rounded-lg p-3 bg-gray-50">
                            <div className="text-sm font-medium mb-2">
                              Generated files
                            </div>
                            ...
                            <div className="text-xs text-gray-500 mt-2">
                              파일은 서버 내부{" "}
                              <code>{runRes.output_dir}</code> 하위에
                              생성됩니다.
                            </div>
                          </div>
                        )}
